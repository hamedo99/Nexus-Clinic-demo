    ...
    return (
        <form action={formAction} className="relative pb-24">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                ...
                <div className={`space-y-6 animate-in fade-in duration-300 ${activeTab === "clinic" ? "block" : "hidden"}`}>
                ...
                <div className={`space-y-6 animate-in fade-in duration-300 ${activeTab === "profile" ? "block" : "hidden"}`}>
                    <div className="border-b border-gray-100 pb-4 mb-6">
                        <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2">
                ...
                {/* 3. Locations Tab */}
                <div className={`space-y-6 animate-in fade-in duration-300 ${activeTab === "locations" ? "block" : "hidden"}`}>
                    <div className="border-b border-gray-100 pb-4 mb-6">
                        <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2">
                ...
                <div className={`space-y-8 animate-in fade-in duration-300 ${activeTab === "schedule" ? "block" : "hidden"}`}>
