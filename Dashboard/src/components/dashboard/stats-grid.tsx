        ...
        return (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <StatCard
                    ...
                    icon={<Building2 className="h-6 w-6 text-teal-600 dark:text-teal-400" />}
                    gradient="from-teal-50 to-white dark:from-teal-900/20 dark:to-gray-900"
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <StatCard
                ...
                icon={<CalendarCheck className="h-6 w-6 text-teal-600 dark:text-teal-400" />}
                gradient="from-teal-50 to-white dark:from-teal-900/20 dark:to-gray-900"
                iconBg="bg-teal-100 dark:bg-teal-900/40"
            />
            <StatCard
